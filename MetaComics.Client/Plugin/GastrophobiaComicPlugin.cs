...
{
    public sealed class GastrophobiaComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.rsspect.com/rss/gastrophobia.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Gastrophobia\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Gastrophobia\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Gastrophobia\\" + currentDate))
                {
        ...
        {
            get { return "http://www.rsspect.com/rss/gastrophobia.xml"; }
        }

        public string Name
        {
            get { return "Gastrophobia"; }
        }
        ...
        {
            return "Gastrophobia Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Gastrophobia"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Gastrophobia");
            }
            return AppSettings.ComicArchiveFolder + "Gastrophobia";
        }

...
{
    public sealed class CatAndGirlComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://catandgirl.com/?feed=rss2");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Cat and Girl\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Cat and Girl\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Cat and Girl\\" + currentDate))
                {
        ...
        {
            get { return "http://catandgirl.com/?feed=rss2"; }
        }

        public string Name
        {
            get { return "Cat and Girl"; }
        }
        ...
        {
            return "Cat and Girl Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder +"\\Cat and Girl"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Cat and Girl");
            }
            return AppSettings.ComicArchiveFolder + @"\" + "Cat and Girl";
        }

...
{
    public sealed class CADComicsPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.cad-comic.com/cad/archive");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\CADComics\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\CADComics\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\CADComics\\" + currentDate))
                {
        ...
        {
            get { return "http://www.cad-comic.com/cad/archive"; }
        }

        public string Name
        {
            get { return "CAD Comics"; }
        }
        ...
        {
            return "CAD Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(Directory.GetCurrentDirectory() + @"\" + "Strip\\CADComics"))
            {
                Directory.CreateDirectory(Directory.GetCurrentDirectory() + @"\" + "Strip");
            }
            return "CADComics";

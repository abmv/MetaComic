...
{
    public sealed class TheDevilsPantiesComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://thedevilspanties.com/feed");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\The Devils Panties\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\The Devils Panties\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\The Devils Panties\\" + currentDate))
                {
        ...
        {
            return "The Devils Panties";
        }

        public string ComicFeedURL
        {
            get { return "http://thedevilspanties.com/feed"; }
        }

        public string Name
        {
            get { return "The Devils Panties"; }
        }
        ...
        {
            return "The Devils Panties Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\The Devils Panties"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "The Devils Panties");
            }
            return AppSettings.ComicArchiveFolder + "The Devils Panties";
        }

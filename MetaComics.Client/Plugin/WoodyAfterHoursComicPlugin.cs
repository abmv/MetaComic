...
{
    public sealed class WoodyAfterHoursComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://feeds.feedburner.com/WoodyAfterHours");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Woody After Hours\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Woody After Hours\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Woody After Hours\\" + currentDate))
                {
        ...
        {
            return "Woody After Hours";
        }

        public string ComicFeedURL
        {
            get { return "http://feeds.feedburner.com/WoodyAfterHours"; }
        }

        public string Name
        {
            get { return "Woody After Hours"; }
        }
        ...
        {
            return "Woody After Hours Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Woody After Hours"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Woody After Hours");
            }
            return AppSettings.ComicArchiveFolder + "Woody After Hours";
        }

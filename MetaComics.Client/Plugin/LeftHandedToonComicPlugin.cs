...
{
    public sealed class LeftHandedToonComicPlugin : IComicPlugin
    {
        ...
        {
            var request =
                (HttpWebRequest) WebRequest.Create("http://feeds.feedburner.com/lefthandedtoons/awesome?format=xml");
        ...
        public void DownloadImageFromFeed(string datepublished, string feeditem)
        {
            ...
            if (x.Count > 0)
            {
                ...
                string folder = CreateFolderStructure(datepublished.Remove(datepublished.Length - 1, 1)) + "\\" + "lht_" +
                                datepublished;
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Left Handed Toon\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Left Handed Toon\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Left Handed Toon\\" + currentDate))
                {
        ...
        {
            return "Left Handed Toons";
        }

        public string ComicFeedURL
        {
            get { return "http://feeds.feedburner.com/lefthandedtoons/awesome?format=xml"; }
        }

        public string Name
        {
            get { return "Left Handed Toons"; }
        }
        ...
        {
            return "Left Handed Toon Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Left Handed Toon"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Left Handed Toon");
            }
            return AppSettings.ComicArchiveFolder + "Left Handed Toon";
        }

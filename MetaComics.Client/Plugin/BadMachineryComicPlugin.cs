...
{
    public sealed class BadMachineryComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://badmachinery.com/index.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Bad Machinery\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Bad Machinery\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Bad Machinery\\" + currentDate))
                {
        ...
        {
            return "Bad Machinery";
        }

        public string ComicFeedURL
        {
            get { return "http://badmachinery.com/index.xml"; }
        }

        public string Name
        {
            get { return "Bad Machinery"; }
        }
        ...
        {
            return "Bad Machinery Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Bad Machinery"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Bad Machinery");
            }
            return AppSettings.ComicArchiveFolder + @"\" + "Bad Machinery";
        }

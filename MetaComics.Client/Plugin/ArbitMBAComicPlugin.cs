...
{
    public sealed class ArbitMBAComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://arbitmba.com/feed");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Arbit MBA\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Arbit MBA\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Arbit MBA\\" + currentDate))
                {
        ...
        {
            get { return "http://arbitmba.com/feed"; }
        }

        public string Name
        {
            get { return "Arbit MBA"; }
        }
        ...
        {
            return "Arbit MBA Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Arbit MBA"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Arbit MBA");
            }
            return AppSettings.ComicArchiveFolder + @"\" + "Arbit MBA";
        }

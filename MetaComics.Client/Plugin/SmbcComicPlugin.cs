...
{
    public sealed class SmbcComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://feeds.feedburner.com/smbc-comics/PvLb");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Saturday Morning Breakfast Cereal\\"))
            {
                di =
                    new DirectoryInfo(Application.StartupPath + "\\Strip\\Saturday Morning Breakfast Cereal\\" +
                                      currentDate);
                if (
                    Directory.Exists(Application.StartupPath + "\\Strip\\Saturday Morning Breakfast Cereal\\" +
                                     currentDate))
                {
        ...
        {
            get { return "http://feeds.feedburner.com/smbc-comics/PvLb"; }
        }

        public string Name
        {
            get { return "Saturday Morning Breakfast Cereal"; }
        }
        ...
        {
            return "Saturday Morning Breakfast Cereal Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Saturday Morning Breakfast Cereal"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Saturday Morning Breakfast Cereal");
            }
            return AppSettings.ComicArchiveFolder + "Saturday Morning Breakfast Cereal";
        }

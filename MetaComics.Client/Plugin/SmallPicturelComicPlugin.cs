...
{
    public sealed class SmallPicturelComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://smallpicture.tumblr.com/rss");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Small Picture\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Small Picture\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Small Picture\\" + currentDate))
                {
        ...
        {
            get { return "http://smallpicture.tumblr.com/rss"; }
        }

        public string Name
        {
            get { return "Small Picture"; }
        }
        ...
        {
            return "Small Picture Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Small Picture"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Small Picture");
            }
            return AppSettings.ComicArchiveFolder + "Small Picture";
        }

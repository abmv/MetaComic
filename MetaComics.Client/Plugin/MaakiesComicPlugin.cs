...
{
    public sealed class MaakiesComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.maakies.com/?feed=rss2");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\maakies\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\maakies\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\maakies\\" + currentDate))
                {
        ...
        {
            get { return "http://www.maakies.com/?feed=rss2"; }
        }
        ...
        {
            return "Maakies Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(Directory.GetCurrentDirectory() + @"\" + "Strip\\Maakies"))
            {
                Directory.CreateDirectory(Directory.GetCurrentDirectory() + @"\" + "Strip");
            }
            return "Maakies";

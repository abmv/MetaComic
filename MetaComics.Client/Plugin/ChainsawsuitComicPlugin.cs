...
{
    public sealed class ChainsawsuitComicPlugin : IComicPlugin
    {
        ...
        public void DownloadImageFromFeed(string datepublished, string feeditem)
        {
            ...
            string folder = CreateFolderStructure(datepublished.Remove(datepublished.Length - 1, 1)) + "\\" + "csst_" +
                            datepublished;
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Chainsawsuit\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Chainsawsuit\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Chainsawsuit\\" + currentDate))
                {
        ...
        {
            get { return "http://feeds.feedburner.com/Chainsawsuit?format=xml"; }
        }

        public string Name
        {
            get { return "Chainsawsuit"; }
        }
        ...
        {
            return "Chainsawsuit Comic Strip Retriver";
        }
        ...
        private static string CreateComicDir()
        {
            ...
            return AppSettings.ComicArchiveFolder + @"\" + "Chainsawsuit";
        }

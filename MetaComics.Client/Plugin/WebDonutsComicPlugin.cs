...
{
    public sealed class WebDonutsComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.webdonuts.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Web Donuts\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Web Donuts\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Web Donuts\\" + currentDate))
                {
        ...
        {
            get { return "http://www.webdonuts.com/feed/"; }
        }

        public string Name
        {
            get { return "Web Donuts"; }
        }
        ...
        {
            return "Web Donuts Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Web Donuts"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Web Donuts");
            }
            return AppSettings.ComicArchiveFolder + "Web Donuts";
        }

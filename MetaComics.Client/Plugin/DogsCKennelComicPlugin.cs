...
{
    public sealed class DogsCKennelComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.johnhartstudios.com/ckennel/atom.xml");
        ...
        public void DownloadImageFromFeed(string datepublished, string feeditem)
        {
            ...
            string folder = CreateFolderStructure(datepublished.Remove(datepublished.Length - 1, 1)) + "\\" + "dck_" +
                            datepublished;
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\The Dogs of C Kennel\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\The Dogs of C Kennel\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\The Dogs of C Kennel\\" + currentDate))
                {
        ...
        {
            return "The Dogs of C Kennel";
        }

        public string ComicFeedURL
        {
            get { return "http://www.johnhartstudios.com/ckennel/atom.xml"; }
        }

        public string Name
        {
            get { return "The Dogs of C Kennel"; }
        }
        ...
        {
            return "The Dogs of C Kennel Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder +  "\\The Dogs of C Kennel"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "The Dogs of C Kennel");
            }
            return AppSettings.ComicArchiveFolder + "The Dogs of C Kennel";
        }

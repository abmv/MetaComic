...
{
    public sealed class TinasGrooveComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.tinasgroove.com/feed");
        ...
        public void DownloadImageFromFeed(string datepublished, string feeditem)
        {
            ...
            string folder = CreateFolderStructure(datepublished.Remove(datepublished.Length - 1, 1)) + "\\" + "tngv_" +
                            datepublished;
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Tinas Groove\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Tinas Groove\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Tinas Groove\\" + currentDate))
                {
        ...
        {
            get { return "http://www.tinasgroove.com/feed"; }
        }

        public string Name
        {
            get { return "Tinas Groove"; }
        }
        ...
        {
            return "Tinas Groove Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Tinas Groove"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Tinas Groove");
            }
            return AppSettings.ComicArchiveFolder + "Tinas Groove";
        }

...
{
    public sealed class KittyHawkComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://kittyhawkcomic.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Kitty Hawk\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Kitty Hawk\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Kitty Hawk\\" + currentDate))
                {
        ...
        {
            get { return "http://kittyhawkcomic.com/feed/"; }
        }

        public string Name
        {
            get { return "Kitty Hawk"; }
        }
        ...
        {
            return "Kitty Hawk Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Kitty Hawk"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Kitty Hawk");
            }
            return AppSettings.ComicArchiveFolder + "Kitty Hawk";
        }

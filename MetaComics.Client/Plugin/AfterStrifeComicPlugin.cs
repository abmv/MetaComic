...
{
    public sealed class AfterStrifeComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://afterstrife.com/?feed=rss2");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\AfterStrife\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\AfterStrife\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\AfterStrife\\" + currentDate))
                {
        ...
        {
            get { return "http://afterstrife.com/?feed=rss2"; }
        }

        public string Name
        {
            get { return "After Strife"; }
        }
        ...
        {
            return "After Strife Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\AfterStrife"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "AfterStrife");
            }
            return AppSettings.ComicArchiveFolder + @"\" + "AfterStrife";
        }

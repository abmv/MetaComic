...
{
    public sealed class PHDComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.phdcomics.com/gradfeed_justcomics.php");
        ...
        public void DownloadImageFromFeed(string datepublished, string feeditem)
        {
            ...
            string folder = CreateFolderStructure(datepublished.Remove(datepublished.Length - 1, 1)) + "\\" + "phd_" +
                            datepublished;
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\PHD\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\PHD\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\PHD\\" + currentDate))
                {
        ...
        {
            get { return "http://www.phdcomics.com/gradfeed_justcomics.php"; }
        }
        ...
        {
            return "PHD Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\PHD"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "PHD");
            }
            return AppSettings.ComicArchiveFolder + "PHD";
        }

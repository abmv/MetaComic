...
{
    public sealed class PFSComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.rsspect.com/rss/pfsc.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\PFS\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\PFS\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\PFS\\" + currentDate))
                {
        ...
        {
            get { return "http://www.rsspect.com/rss/pfsc.xml"; }
        }
        ...
        {
            return "PFS Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\PFS"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "PFS");
            }
            return AppSettings.ComicArchiveFolder + "PFS";
        }

...
{
    public sealed class FoxTrotComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://feeds.feedburner.com/Foxtrotcom");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Foxtrotcom\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Foxtrotcom\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Foxtrotcom\\" + currentDate))
                {
        ...
        {
            get { return "http://feeds.feedburner.com/Foxtrotcom"; }
        }
        ...
        {
            return "Foxtrot Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Foxtrotcom"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Foxtrotcom");
            }
            return AppSettings.ComicArchiveFolder + "Foxtrotcom";
        }

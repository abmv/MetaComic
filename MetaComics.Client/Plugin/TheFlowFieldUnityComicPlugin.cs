...
{
    public sealed class TheFlowFieldUnityComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://theflowfieldunity.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\The Flow Field Unity\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\The Flow Field Unity\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\The Flow Field Unity\\" + currentDate))
                {
        ...
        {
            return "The Flow Field Unity";
        }

        public string ComicFeedURL
        {
            get { return "http://theflowfieldunity.com/feed/"; }
        }

        public string Name
        {
            get { return "The Flow Field Unity"; }
        }
        ...
        {
            return "The Flow Field Unity Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\The Flow Field Unity"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "The Flow Field Unity");
            }
            return AppSettings.ComicArchiveFolder + "The Flow Field Unity";
        }

...
{
    public sealed class AchewoodComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.achewood.com/rss.php");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Achewood\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Achewood\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Achewood\\" + currentDate))
                {
        ...
        {
            get { return "http://www.achewood.com/rss.php"; }
        }
        ...
        {
            return "Achewood Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Achewood"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Achewood");
            }
             return AppSettings.ComicArchiveFolder + @"\" + "Achewood";
        }

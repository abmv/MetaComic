...
{
    public sealed class WondermarkComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://feeds.feedburner.com/wondermark");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Wondermark\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Wondermark\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Wondermark\\" + currentDate))
                {
        ...
        {
            get { return "http://feeds.feedburner.com/wondermark"; }
        }

        public string Name
        {
            get { return "Wondermark"; }
        }
        ...
        {
            return "Wondermark Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Wondermark"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Wondermark");
            }
            return AppSettings.ComicArchiveFolder + "Wondermark";
        }

...
{
    public sealed class GarfieldComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.arcamax.com/garfield/channelfeed");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Garfield\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Garfield\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Garfield\\" + currentDate))
                {
        ...
        {
            get { return "http://www.arcamax.com/garfield/channelfeed"; }
        }
        ...
        {
            return "Garfield Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Garfield"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Garfield");
            }
            return AppSettings.ComicArchiveFolder + "Garfield";
        }

...
{
    public sealed class DieselSweetiesComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.dieselsweeties.com/ds-unifeed.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Diesel Sweeties\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Diesel Sweeties\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Diesel Sweeties\\" + currentDate))
                {
        ...
        {
            return "Diesel Sweeties";
        }

        public string ComicFeedURL
        {
            get { return "http://www.dieselsweeties.com/ds-unifeed.xml"; }
        }

        public string Name
        {
            get { return "Diesel Sweeties"; }
        }
        ...
        {
            return "Diesel Sweeties Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Diesel Sweeties"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Diesel Sweeties");
            }
            return AppSettings.ComicArchiveFolder + "Diesel Sweeties";
        }

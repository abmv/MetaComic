...
{
    public sealed class LAWLSComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://lawlscomic.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\LAWLS\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\LAWLS\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\LAWLS\\" + currentDate))
                {
        ...
        {
            get { return "http://lawlscomic.com/feed/"; }
        }
        ...
        {
            return "LAWLS Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\LAWLS"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "LAWLS");
            }
            return AppSettings.ComicArchiveFolder + "LAWLS";
        }

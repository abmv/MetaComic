...
{
    public sealed class TemplarAZComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://feeds2.feedburner.com/templaraz");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Templar AZ\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Templar AZ\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Templar AZ\\" + currentDate))
                {
        ...
        {
            get { return "http://feeds2.feedburner.com/templaraz"; }
        }

        public string Name
        {
            get { return "Templar AZ"; }
        }
        ...
        {
            return "Templar AZ Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Templar AZ"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Templar AZ");
            }
            return AppSettings.ComicArchiveFolder + "Templar AZ";
        }

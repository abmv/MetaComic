...
{
    public sealed class NorthworldComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.rsspect.com/rss/northworldcomic.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Northworld\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Northworld\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Northworld\\" + currentDate))
                {
        ...
        {
            get { return "http://www.rsspect.com/rss/northworldcomic.xml"; }
        }

        public string Name
        {
            get { return "Northworld"; }
        }
        ...
        {
            return "Northworld Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Northworld"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Northworld");
            }
            return AppSettings.ComicArchiveFolder + "Northworld";
        }

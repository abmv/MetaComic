...
{
    public sealed class JustABitOffComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://feeds.feedburner.com/JustABitOff?format=xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\JustABitOff\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\JustABitOff\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\JustABitOff\\" + currentDate))
                {
        ...
        {
            return "Just A Bit Off";
        }

        public string ComicFeedURL
        {
            get { return "http://feeds.feedburner.com/JustABitOff?format=xml"; }
        }

        public string Name
        {
            get { return "Just A Bit Off"; }
        }
        ...
        {
            return "Just A Bit Off Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\JustABitOff"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "JustABitOff");
            }
            return AppSettings.ComicArchiveFolder + "JustABitOff";
        }

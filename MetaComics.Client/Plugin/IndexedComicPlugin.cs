...
{
    public sealed class IndexedComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://thisisindexed.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\This is Indexed\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\This is Indexed\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\This is Indexed\\" + currentDate))
                {
        ...
        {
            return "This is Indexed";
        }

        public string ComicFeedURL
        {
            get { return "http://thisisindexed.com/feed/"; }
        }

        public string Name
        {
            get { return "This is Indexed"; }
        }
        ...
        {
            return "This is Indexed Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\This is Indexed"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "This is Indexed");
            }
            return AppSettings.ComicArchiveFolder + "This is Indexed";
        }

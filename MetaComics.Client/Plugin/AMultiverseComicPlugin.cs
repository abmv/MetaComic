...
{
    public sealed class AMultiverseComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://amultiverse.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\A Multiverse\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\A Multiverse\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\A Multiverse\\" + currentDate))
                {
        ...
        {
            get { return "http://amultiverse.com/feed/"; }
        }

        public string Name
        {
            get { return "A Multiverse"; }
        }
        ...
        {
            return "A Multiverse Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\A Multiverse"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "A Multiverse");
            }
            return AppSettings.ComicArchiveFolder + @"\" + "A Multiverse";
        }

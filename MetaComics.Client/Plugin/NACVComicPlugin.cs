...
{
    public sealed class NACVComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.newadventuresofqueenvictoria.com/tnaoqv.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\NACV\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\NACV\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\NACV\\" + currentDate))
                {
        ...
        {
            return "New Adventures of Queen Victoria";
        }

        public string ComicFeedURL
        {
            get { return "http://www.newadventuresofqueenvictoria.com/tnaoqv.xml"; }
        }

        public string Name
        {
            get { return "New Adventures of Queen Victoria"; }
        }
        ...
        {
            return "New Adventures of Queen Victoria Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(Directory.GetCurrentDirectory() + @"\" + "Strip\\NACV"))
            {
                Directory.CreateDirectory(Directory.GetCurrentDirectory() + @"\" + "Strip");
            }
            return "NACV";

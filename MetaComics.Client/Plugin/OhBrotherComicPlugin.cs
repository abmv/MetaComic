...
{
    public sealed class OhBrotherComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://ohbrothercomics.com/feed/atom");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Oh Brother\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Oh Brother\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Oh Brother\\" + currentDate))
                {
        ...
        {
            get { return "http://ohbrothercomics.com/feed/atom"; }
        }

        public string Name
        {
            get { return "Oh Brother"; }
        }
        ...
        {
            return "Oh Brother Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Oh Brother"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Oh Brother");
            }
             return AppSettings.ComicArchiveFolder + @"\" + "Oh Brother";
        }

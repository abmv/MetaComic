...
{
    internal class RSSFeedGenerator
    {
        ...
        private string _generator = "Axero Solutions RSS Generator";
        ...
        public RSSFeedGenerator(Stream stream, Encoding encoding)
        {
            writer = new XmlTextWriter(stream, encoding);
            writer.Formatting = Formatting.Indented;
        }

        public RSSFeedGenerator(TextWriter w)
        {
        ...
        public void WriteItem(string title, string link, string description, string author, string category,
                              string comments, string guid, DateTime pubDate, string source, string encUrl,
                              string encLength, string encType)
        {
            try
            {

...
{
    public sealed class DinosaurComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.rsspect.com/rss/qwantz.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Dinosaur Comic\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Dinosaur Comic\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Dinosaur Comic\\" + currentDate))
                {
        ...
        {
            return "Dinosaur Comic";
        }

        public string ComicFeedURL
        {
            get { return "http://www.rsspect.com/rss/qwantz.xml"; }
        }

        public string Name
        {
            get { return "Dinosaur Comic"; }
        }
        ...
        {
            return "Dinosaur Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder  + "\\Dinosaur Comic"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Dinosaur Comic");
            }
            return AppSettings.ComicArchiveFolder + "Dinosaur Comic";
        }

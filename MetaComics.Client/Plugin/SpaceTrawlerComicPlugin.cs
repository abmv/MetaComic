...
{
    public sealed class SpaceTrawlerComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://spacetrawler.com/feed/");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Space Trawler\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Space Trawler\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Space Trawler\\" + currentDate))
                {
        ...
        {
            return "Space Trawler";
        }

        public string ComicFeedURL
        {
            get { return "http://spacetrawler.com/feed/"; }
        }

        public string Name
        {
            get { return "Space Trawler"; }
        }
        ...
        {
            return "Space Trawler Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Space Trawler"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Space Trawler");
            }
            return AppSettings.ComicArchiveFolder + "Space Trawler";
        }

...
{
    public sealed class DayByDayComicPlugin : IComicPlugin
    {
        #region IComicPlugin Members

        public void ReadComicStripFeed()
        {
            var request = (HttpWebRequest) WebRequest.Create("http://www.daybydaycartoon.com/atom.xml");
        ...
        public Image ComicOfTheDay()
        {
            ...
            if (Directory.Exists(Application.StartupPath + "\\Strip\\Day by Day\\"))
            {
                di = new DirectoryInfo(Application.StartupPath + "\\Strip\\Day by Day\\" + currentDate);
                if (Directory.Exists(Application.StartupPath + "\\Strip\\Day by Day\\" + currentDate))
                {
        ...
        {
            get { return "http://www.daybydaycartoon.com/atom.xml"; }
        }

        public string Name
        {
            get { return "Day by Day"; }
        }
        ...
        {
            return "Day by Day Comic Strip Retriver";
        }
        ...
        {
            if (!Directory.Exists(AppSettings.ComicArchiveFolder + "\\Day by Day"))
            {
                Directory.CreateDirectory(AppSettings.ComicArchiveFolder + @"\" + "Day by Day");
            }
            return AppSettings.ComicArchiveFolder + @"\" + "Day by Day";
        }
